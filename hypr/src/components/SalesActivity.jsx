...
export default function Example() {
  return (
    <div>
      <div className=" text-3xl font-semibold leading-6 text-gray-200 p-8">
        Sales Activity
      </div>

      <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 p-8 -mt-10">
        {stats.map((item) => (
          <div
            key={item.id}
